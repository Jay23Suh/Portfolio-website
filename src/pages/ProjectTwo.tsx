    ...
    <div className="container mx-auto px-4 py-12 text-[#001d36]" >
      ...
      <div className="container mx-auto px-6 py-12 max-w-screen-lg">
        ...
        <section className="mb-12 text-center">
          ...
          <p className="text-xl ">A case study exploring the "connected" work experience for cross-campus staff.</p>
        </section>
        ...
        {/* Research Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-semibold mb-4">Empathize & Define</h2>
        ...
        {/* Solution Section */}
        <section className="mb-16">
          <h2 className="text-3xl  font-semibold mb-4">Ideate</h2>
          <p className="text-lg  leading-relaxed mb-6">
      ...
      {/* Embed PDF */}
      <h3 className="text-2xl  font-semibold mb-4">Project write-up</h3>
      <iframe
