    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <section className="mb-12 text-center">
                <h1 className="text-5xl font-bold mb-4 text-white">Saver Sports: Empowering Youth Through Sports</h1>
            ...
            {/* Research Section */}
            <section className="mb-16">
                <h2 className="text-3xl font-semibold mb-4 text-white">Call to action</h2>
            ...
            {/* Solution Section */}
            <section className="mb-16">
                <h2 className="text-3xl font-semibold mb-4 text-white">Our work</h2>
                <p className="text-lg text-white leading-relaxed mb-6">
                    <p className="text-lg text-white leading-relaxed mb-6">
