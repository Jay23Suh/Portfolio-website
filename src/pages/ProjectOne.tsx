    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="container mx-auto px-6 py-12 max-w-screen-lg">
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold mb-4 text-[#001d36]">Problem Statement</h2>
                    <p className="text-lg text-[#001d36] leading-relaxed">
                ...
                {/* Research Section */}
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold mb-4 text-[#001d36]">Empathize & Define</h2>
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold mb-4 text-[#001d36]">Ideate</h2>
                    <p className="text-lg text-[#001d36] leading-relaxed mb-6">
            ...
            <h3 className="text-2xl text-[#001d36] font-semibold mb-4">Project write-up</h3>
            {/* Embed PDF */}
            <embed
                src="/Navigating Family Connections through Distance and Neurodiversity.pdf"
